            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="max-w-lg mx-auto">
                    ...
                    <form action="{{route('compra.store')}}" method="POST">
                        ...
                        <label for="idproveedor" class="inline-block w-20 mr-6 text-right font-bold text-gray-600">
                            idproveedor:
                        </label>
                        <div class="flex items-center mb-5">
                            <select name="idproveedor" class="flex-1 py-2 border-b-2 border-gray-400 focus:border-green-400
                                ...
                                @foreach ($proveedor as $proveedor)
                                    <option value="{{$proveedor->idproveedor}}">{{$proveedor->nombres}}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <label for="idproduct" class="inline-block w-20 mr-6 text-right font-bold text-gray-600">
                            idproducto:
                        </label>
                        <div class="flex items-center mb-5">
