    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            border-b border-gray-600">
                                        <th class="px-4 py-3">idcompra</th>
                                ...
                                <tbody class="bg-white">
                                    @foreach ($compra as $compra)
                                        <tr class="text-gray-700">
                                            ...
                                            <td class="px-4 py-3 text-ms font-semibold border">{{ $compra->idproveedor }}</td>
                                            <td class="px-4 py-3 text-ms font-semibold border">{{ $compra->idempleado }}</td>
                                            <td class="px-4 py-3 text-ms font-semibold border">{{ $compra->idproducto }}</td>
