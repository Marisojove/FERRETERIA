                ...
                <div class="max-w-lg mx-auto">
                    ...
                    <form action="{{route('proveedor.update', $proveedor)}}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input value=" {{old('nombres', $proveedor->nombres)}} " type="text" id="nombres" name="nombres"
                        ...
                        <div class="mb-6">
                            ...
                            <input value=" {{old('apellidos', $proveedor->apellidos)}} " type="text" id="apellidos" name="apellidos"
                            class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500
                            focus:border-blue-500 block w-full p-2.5"  required="">
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input value=" {{old('celular', $proveedor->celular)}} " type="number" id="celular" name="celular"
                            class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500
                            focus:border-blue-500 block w-full p-2.5"  required="">
                        </div>
                        <div class="mb-6">
                            <label for="fecha" class="text-sm font-medium text-gray-900 block mb-2">fecha:</label>
                            <input value=" {{old('fecha', $proveedor->fecha)}} " type="date" id="fecha" name="fecha"
                            class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500
                            focus:border-blue-500 block w-full p-2.5"  required="">
                        </div>
